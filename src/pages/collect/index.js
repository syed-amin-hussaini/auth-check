          ...
          {cookieCollect.map((item, i) => {
            ...
            return (
              <div 
                ...
                key={i}
              >
                {item.status !== "open" && <span className="position-absolute float-center">
                  { <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="#fff" class="bi bi-clock-history" viewBox="0 0 16 16">
